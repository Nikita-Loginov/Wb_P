...
const summAdditionallyItem = document.querySelectorAll('.summ-additionally__item');

summAdditionallyItem.forEach(function(item){
    item.addEventListener('click',function(){
        let currentAnswerItem = item.querySelector('.summ-additionally__answerbox');
