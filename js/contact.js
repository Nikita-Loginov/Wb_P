...
const accordeonItems = document.querySelector('.accordeon__items');
const accordeonItem = document.querySelectorAll('.accordeon__item');
const accordeonAnswer = document.querySelector('.accordeon__answer')

accordeonItem.forEach(function(item){
    item.addEventListener('click',function(){
        let currentAnswerItem = item.querySelector('.accordeon__answer')
        item.classList.toggle('open') 
        if(item.classList.contains('open')) {
            currentAnswerItem.style.maxHeight = currentAnswerItem.scrollHeight + 'px';
            console.log(currentAnswerItem.style.maxHeight)
        } else{
