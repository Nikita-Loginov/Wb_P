...
const placingOrderModel = document.querySelector('.placingOrderModel');
const itogBtnModel = document.querySelector('.itog-confirmation__order-btn');
const placingOrderModelClose = document.querySelector('.placingOrderModel__close');
const placingOrderModelContentLink = document.querySelector('.placingOrderModel__content-link')

itogBtnModel.addEventListener('click',function(){
    placingOrderModel.classList.add('open')
    body.classList.add('open--placingModel')
})

placingOrderModelClose.addEventListener('click',function(){
    placingOrderModel.classList.remove('open')
    body.classList.remove('open--placingModel')
})

placingOrderModelContentLink.addEventListener('click',function(e){
    e.preventDefault()
    placingOrderModel.classList.remove('open')
    body.classList.remove('open--placingModel')
})

placingOrderModel.addEventListener('click',function(e){
    if(!e.target.closest('.placingOrderModel__inner')){
        placingOrderModel.classList.remove('open')
        body.classList.remove('open--placingModel')
    }
})
