...
const personalAreaFilterBtn = document.querySelectorAll('.personalArea__filter-btn');
const personalAreaItem = document.querySelectorAll('.personalArea__item')

personalAreaFilterBtn.forEach(function(item){
    item.addEventListener('click',function(){
        let currentBtnId = this.id;
        let currentContentItem = document.querySelector(`.${currentBtnId}`);
        
        personalAreaFilterBtn.forEach(function(item){
            item.classList.remove('active')
        })
        personalAreaItem.forEach(function(item){
            item.classList.remove('active')
        })
